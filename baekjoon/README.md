# 📘 Baekjoon Algorithm Roadmap

> 백준 단계별 문제들을 효율적으로 재구성한 커리큘럼  
> 기초 → 자료구조 → 탐색 → DP → 심화 순
...
- [ ] [1158](https://www.acmicpc.net/problem/1158) 요세푸스 문제
- [ ] [1168](https://www.acmicpc.net/problem/1168) 요세푸스 문제 2

---

## 📌 2단계. 기초 수학 & 수론

**개념:** GCD, LCM, 소수, 진법 변환, 조합론
...
- [ ] [11055](https://www.acmicpc.net/problem/11055) 가장 큰 증가하는 부분 수열
...
**개념:** 브루트포스, DFS 백트래킹, meet-in-the-middle

**문제:**
- [ ] [1476](https://www.acmicpc.net/problem/1476) 날짜 계산
- [ ] [1107](https://www.acmicpc.net/problem/1107) 리모컨
...
- [ ] [1208](https://www.acmicpc.net/problem/1208) 부분수열의 합 2
...
**문제:**
- [ ] [2166](https://www.acmicpc.net/problem/2166) 다각형의 넓이
...
- [ ] [2254](https://www.acmicpc.net/problem/2254) 감옥

---

## 📌 15단계. 네트워크 플로우

**개념:** 최대유량, 최소비용 최대유량, 이분매칭
...
# 🚀 백준 투 포인터/슬라이딩 윈도우 문제 난이도별 완전 정리

> **12892번으로 투포인터 맛보셨다면, 이제 체계적으로 정복해봐요!** 🔥

## 📚 투 포인터 vs 슬라이딩 윈도우 개념 정리

### 🎯 투 포인터 (Two Pointers)
- **구간 길이가 가변적**
- 두 포인터가 조건에 따라 자유롭게 움직임
- 주로 합/차이가 특정 조건을 만족하는 구간 찾기

### 🪟 슬라이딩 윈도우 (Sliding Window)  
- **구간 길이가 고정적**
- 정해진 크기의 "창문"을 한 칸씩 이동
- 주로 고정 길이 구간에서 최대/최소값 찾기
...
### 🔰 기초 중의 기초
- **[2003번 - 수들의 합 2](https://www.acmicpc.net/problem/2003)** ⭐⭐⭐ **필수**
  - 난이도: 실버4 
  - 유형: 투 포인터 기본
  - 핵심: 연속 부분 수열의 합이 M인 경우의 수
  - 💡 투포인터 첫 문제로 완벽!

- **[1940번 - 주몽](https://www.acmicpc.net/problem/1940)** 
  - 난이도: 실버4
  - 유형: 정렬 + 투 포인터
  - 핵심: 두 재료의 고유 번호 합이 M인 경우

### 🎯 기본기 다지기
- **[3273번 - 두 수의 합](https://www.acmicpc.net/problem/3273)** ⭐⭐⭐ 
  - 난이도: 실버3
  - 유형: 정렬 + 양 끝에서 시작하는 투 포인터
  - 핵심: 서로 다른 두 수의 합이 x인 쌍의 개수

- **[10025번 - 게으른 백곰](https://www.acmicpc.net/problem/10025)**
  - 난이도: 실버3  
  - 유형: 슬라이딩 윈도우 기본
  - 핵심: 고정 길이 구간에서 얼음양 최대값
...
### 🔥 중급 필수 문제들
- **[1806번 - 부분합](https://www.acmicpc.net/problem/1806)** ⭐⭐⭐⭐ **핵심**
  - 난이도: 골드4
  - 유형: 투 포인터 (구간 길이 최소값)
  - 핵심: 연속된 수들의 부분합이 S 이상이 되는 최소 길이

- **[2470번 - 두 용액](https://www.acmicpc.net/problem/2470)** ⭐⭐⭐⭐
  - 난이도: 골드5 
  - 유형: 정렬 + 양 끝 투 포인터
  - 핵심: 두 용액을 섞어 0에 가장 가까운 값 만들기

- **[2473번 - 세 용액](https://www.acmicpc.net/problem/2473)**
  - 난이도: 골드3
  - 유형: 정렬 + 고정 + 투 포인터
  - 핵심: 세 용액을 섞어 0에 가장 가까운 값

### 🪟 슬라이딩 윈도우 심화
- **[2531번 - 회전 초밥](https://www.acmicpc.net/problem/2531)** ⭐⭐⭐⭐
  - 난이도: 골드4
  - 유형: 원형 슬라이딩 윈도우
  - 핵심: 연속해서 k개 접시, 서로 다른 초밥 종류 최대값

- **[15961번 - 회전 초밥 (large)](https://www.acmicpc.net/problem/15961)**
  - 난이도: 골드4
  - 유형: 2531번의 데이터 확장판
  - 효율성 체크 문제
...
- **[11003번 - 최솟값 찾기](https://www.acmicpc.net/problem/11003)** 
  - 난이도: 골드1
  - 유형: 슬라이딩 윈도우 + 덱(deque)
  - 핵심: 각 구간에서 최솟값을 빠르게 찾기

### 🎨 응용 문제들
- **[20922번 - 겹치는 건 싫어](https://www.acmicpc.net/problem/20922)**
  - 난이도: 실버1
  - 유형: 투 포인터 + 빈도 체크
  - 핵심: 같은 정수가 K개 이하로만 들어있는 최장 연속 부분 수열

- **[22862번 - 가장 긴 짝수 연속 부분 수열](https://www.acmicpc.net/problem/22862)**
  - 난이도: 골드5
  - 유형: 투 포인터 + 조건부 제거
  - 핵심: K개 이하의 수를 제거해서 만들 수 있는 가장 긴 짝수 수열
...
### 🔥 고급 투 포인터
- **[12892번 - 생일 선물](https://www.acmicpc.net/problem/12892)** ⭐⭐⭐⭐⭐ **바로 이 문제!**
  - 난이도: 골드2
  - 유형: 정렬 + 투 포인터 + 구조체
  - 핵심: 가격 차이 조건 만족하는 선물들의 가치 합 최대값

- **[1208번 - 부분수열의 합 2](https://www.acmicpc.net/problem/1208)**
  - 난이도: 골드2
  - 유형: Meet in the Middle + 투 포인터
  - 핵심: 절반으로 나누어 모든 경우 계산 후 투 포인터로 매칭

- **[7453번 - 합이 0인 네 정수](https://www.acmicpc.net/problem/7453)**
  - 난이도: 골드2  
  - 유형: Meet in the Middle + 정렬 + 투 포인터
  - 핵심: 4개 배열에서 하나씩 선택해서 합이 0인 경우의 수

### 🏆 최고 난이도 도전
- **[2143번 - 두 배열의 합](https://www.acmicpc.net/problem/2143)**
  - 난이도: 골드3
  - 유형: 부분합 + 정렬 + 투 포인터  
  - 핵심: 두 배열의 부분합들을 조합해서 T 만들기

- **[1644번 - 소수의 연속합](https://www.acmicpc.net/problem/1644)**
  - 난이도: 골드3
  - 유형: 에라토스테네스의 체 + 투 포인터
  - 핵심: 연속된 소수들의 합으로 N을 나타내는 방법의 수

- **[13144번 - List of Unique Numbers](https://www.acmicpc.net/problem/13144)**
  - 난이도: 골드4
  - 유형: 투 포인터 + 중복 체크
  - 핵심: 서로 다른 정수로만 이루어진 연속 부분 수열 개수
...
### 💎 최고 수준 도전
- **[1517번 - 버블 소트](https://www.acmicpc.net/problem/1517)**
  - 난이도: 플래티넘5
  - 유형: 머지소트 + 투 포인터 (inversion counting)

- **[3151번 - 합이 0](https://www.acmicpc.net/problem/3151)**
  - 난이도: 골드4
  - 유형: 정렬 + 고정 + 투 포인터 + 중복 처리

- **[1484번 - 다이어트](https://www.acmicpc.net/problem/1484)**
  - 난이도: 골드5
  - 유형: 수학 + 투 포인터
  - 핵심: 현재 몸무게² - 기억 몸무게² = G인 자연수 쌍
...
### 🎯 1단계: 기초 다지기 (1~2주)
```
2003(수들의 합2) → 3273(두 수의 합) → 1940(주몽) → 10025(게으른 백곰)
```
**목표:** 투포인터와 슬라이딩 윈도우 기본 개념 완전 이해

### 🔥 2단계: 중급 도전 (2~3주)  
```
1806(부분합) → 2470(두 용액) → 2531(회전 초밥) → 20922(겹치는 건 싫어)
```
**목표:** 다양한 조건과 제약이 있는 문제 해결 능력

### 💪 3단계: 고급 정복 (3~4주)
```
12892(생일 선물) → 2473(세 용액) → 11003(최솟값 찾기) → 22862(가장 긴 짝수 연속)
```
**목표:** 복잡한 자료구조와의 결합, 최적화 기법

### 🏆 4단계: 마스터 도전 (4주+)
```
1208(부분수열의 합2) → 7453(합이 0인 네 정수) → 1644(소수의 연속합) → 13144(List of Unique Numbers)
```
**목표:** Meet in the Middle, 고급 알고리즘과의 융합
...
```
**대표 문제:** 2003, 1806, 12892

### 🎨 패턴 2: 양방향 투 포인터 (양 끝에서 시작)
```c
...
```
**대표 문제:** 3273, 2470, 2473

### 🎨 패턴 3: 슬라이딩 윈도우 (고정 크기)
```c
for (int i = 0; i < k; i++) sum += arr[i]; // 초기 윈도우
for (int i = k; i < n; i++) {
    sum += arr[i] - arr[i-k]; // 슬라이딩
    // 결과 갱신
}
```
**대표 문제:** 2531, 15961, 11003

### 🎨 패턴 4: Meet in the Middle + 투 포인터
```c
// 절반씩 나누어 모든 부분합 구하기
// 정렬 후 투 포인터로 조건 만족하는 쌍 찾기
```
**대표 문제:** 1208, 7453, 2143
